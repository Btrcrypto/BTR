...
function usage()
{
    ...
    echo "and generates the checksum files of the btr tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/btr/btr.git"
CLONE_DIR="$BUILD_DIRECTORY/btr-buildall"
TARGET_DIR="$BUILD_DIRECTORY/btr-releases"
DYNAMIC_RELEASE="btr-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="btr-${TAG_VERSION}-linux-staticboost-CLI"
